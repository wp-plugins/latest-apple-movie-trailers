=== Plugin Name ===
Contributors: sebd86
Donate link: http://www.sebs-studio.com
Tags: Posters, Trailers, Movies, Promotion, Entertainment, RSS, Feed, Apple, Films
Requires at least: 2.7.0
Tested up to: 3.1
Stable tag: trunk

Displays latest movie trailers from http://trailers.apple.com/ along with poster and description.
...
2. Upload folder `latest_apple_movie_trailers` to the `/wp-content/plugins/` directory
